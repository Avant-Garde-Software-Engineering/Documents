...
\paragraph{Three.js}
Three.js è una libreria JavaScript open-source utilizzata per la realizzazione di contenuti 3D per il Web. In particolare, utilizza le API WebGL per integrare ambienti 3D a siti web tramite semplice canvas html.
...
\begin{itemize}
        ...
        \item React.js: \url{https://react.dev/learn}
        \item Next.js: \url{https://nextjs.org/docs}
        \item Three.js: \url{https://threejs.org/docs/index.html#manual/en/introduction/Installation}
        \item React Three Fiber: \url{https://docs.pmnd.rs/react-three-fiber/getting-started/introduction}
        \item Zustand: \url{https://docs.pmnd.rs/zustand/getting-started/introduction}
        \item Tailwind CSS: \url{https://tailwindcss.com/docs/installation}
    \end{itemize}
