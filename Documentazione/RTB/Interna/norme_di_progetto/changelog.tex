\section*{\Large Registro delle Modifiche}
    \begin{table}[h]
        ...
        \begin{tabularx}{0.98\textwidth}
            ...
            v2.0.1 & 24-03-24 & Jessica Carretta & Amministratore & Scrittura delle sotto-sezioni \ref{sec:codifica:convenzioni}, \ref{sec:sviluppo:strumenti} e \ref{sec:gestione_operativa}. Modifica sotto-sezione \ref{sec:riferimenti_esterni:materiali_di_studio}. \\
            \hline
        \end{tabularx}
    \end{table}