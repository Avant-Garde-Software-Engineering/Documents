...
\subsection{Accertamento della qualità} \label{sec:accertamento delle qualita}
...
\begin{itemize}
    ...
    \item MPC15-EOD \textcolor{green}{Soddisfatta}
    \item MPC16-IG \textcolor{green}{Soddisfatta}
\end{itemize}

La percentuale di metriche soddisfatte equivale al \textcolor{green}{100\%}
