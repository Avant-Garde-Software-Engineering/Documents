...
\entry{Complessità Ciclomatica}{La complessità ciclomatica di una sezione di codice è il numero di cammini linearmente indipendenti attraverso il codice sorgente. La formula della complessità ciclomatica è data da:\\
\begin{center}
\textbf{M=E-N+2P}\\
\end{center}
dove:\\
M è la complessità ciclomatica, \\
E rappresenta il numero di archi nel grafo, \\
N è il numero di nodi,\\ 
P è il numero di componenti connesse al grafo.}
\addcontentsline{toc}{section}{C}

\newpage
\section*{D}
\entry{Deliverable}{Il prodotto software comprensivo di documentazione in una determinata fase interna del progetto.}
\entry{Design pattern}{Soluzione progettuale generale ad un problema ricorrente, che può essere adattata a contesti differenti.}
\entry{Diagramma di Gantt}{Strumento di supporto alla gestione dei progetti, che permette di visualizzare la pianificazione temporale delle attività di un progetto.}
\entry{Dominio applicativo}{L'insieme dei problemi e delle soluzioni che caratterizzano un determinato settore di applicazione.}
...
\newpage
\section*{F}
\entry{Feature}{Caratteristica o funzionalità di un prodotto software.}
...
\entry{Item}{Prodotto presente all'interno del magazzino creato, che può essere spostato o eliminato.}
...
\newpage
\section*{P}
\entry{Processo software}{Un insieme di attività, metodi, pratiche e trasformazioni che persone coinvolte in un progetto software devono seguire per sviluppare un prodotto software.}
...
\entry{Proponente}{Entità che propone un capitolato d'appalto, ovvero un'azienda o un ente che ha un problema da risolvere e cerca un'azienda che possa realizzare un prodotto software per risolverlo.}
...
\entry{Sprint}{Periodo di tempo, di durata fissa e prefissata, in cui il team di sviluppo lavora per completare un insieme di attività, con l'obiettivo di consegnare un incremento di prodotto software. Per questo progetto, secondo le norme di progetto adottate, la durata di uno sprint è di due settimane.}
...
\newpage
\section*{T}
\entry{Template}{Modello predefinito che può essere riutilizzato per creare documenti simili, in modo da garantire uniformità e coerenza tra i documenti prodotti.}
