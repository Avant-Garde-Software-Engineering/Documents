...
\begin{xltabular}{\textwidth}{ p{0.1\textwidth} | X | p{0.3\textwidth} }
    ...
    ROF\_6.2.3 & L'utente può scegliere la dimensione del bin per la scaffalatura & Esplicito, Verbale esterno 16-02-24 [UC6.3]\\
...
\begin{xltabular}{\textwidth}{ p{0.3\textwidth} | X | p{0.2\textwidth} }
    ...
    \rowcolor{gray!10}UC4.2 & Visualizzazione elenco prodotti & ROF\_5.2\\ 
    UC4.2.1.1 & visualizzazione nome prodotto & ROF\_5.2.1\\
    %UC4.2.1.2 & Visualizzazione dimensioni prodotto & ROF\_5.2.2\\
    \rowcolor{gray!10}UC4.2.2.1 & Visualizzazione scaffalatura di residenza & ROF\_5.2.2\\ 
    UC6 & Creazione scaffalatura & ROF\_6\\
    \rowcolor{gray!10}UC6.1 & Inserimento codice & ROF\_6.1\\
    UC6.2 & Inserimento dimensioni & ROF\_6.2\\
    \rowcolor{gray!10}UC6.3 & Inserimento dimensioni bin & ROF\_6.3\\
    UC7 & Posizionamento scaffalatura & ROF\_7\\
    \rowcolor{gray!10}UC8 & Selezione scaffalatura & ROF\_8\\
    UC8.1 & Selezione scaffalatura in libreria & ROF\_8.1\\
    \rowcolor{gray!10}UC8.1.1 & Evidenziazione scaffalatura in libreria & RFF\_8.1.1\\
    UC8.2 & Selezione scaffalatura in render 3D & ROF\_8.2\\
    \rowcolor{gray!10}UC8.2.1 & Evidenziazione scaffalatura in render 3D & RFF\_8.1.1\\
    UC9 & Modifica scaffalatura & ROF\_9\\
    \rowcolor{gray!10}UC9 & Modifica codice scaffalatura & ROF\_9.1\\
    UC9.2 &  Modifica codice scaffalatura & RDF\_9.2\\
    \rowcolor{gray!10}UC9.3 & Modifica posizione scaffalatura & RDF\_9.3\\
    UC10 & Ricerca scaffalatura per codice & RDF\_10\\
    \rowcolor{gray!10}UC12 & Cancellazione scaffalatura & ROF\_11\\
    UC12.2 &  Cancellazione scaffalatura da libreria & ROF\_11.1\\
    \rowcolor{gray!10}UC12.3 & Cancellazione scaffalatura da render 3D & ROF\_11.2\\
    UC13 & Creazione prodotto & ROF\_12\\
    \rowcolor{gray!10}UC13.1 & Inserimento nome & ROF\_12.1\\    
...
\begin{table}[h]
    ...
    \begin{tabular}{|l|c|c|c||c|}
        ...
        \cellcolor{black} \textbf{\color{white}Funzionali} & 47 & 10 & 7 & \textbf{64}\\
        \cellcolor{black} \textbf{\color{white}Di qualità} & 6 & 1 & 0 & \textbf{7}\\
        \cellcolor{black} \textbf{\color{white}Di sistema} & 7 & 0 & 2 & \textbf{9}\\

        \hline\hline
        \cellcolor{black} \textbf{\color{white}Totale complessivo} & \textbf{60} & \textbf{11} & \textbf{9} & \textbf{80}\\
        \hline
    \end{tabular}
\end{table}
