\newgeometry{top=45mm,bottom=45mm,right=45mm,left=45mm}
    \begin{titlepage}
        \begin{center}
            ...
            \vspace{0.3cm}
                \begin{tabular}{ r | l }
                    \textbf{Versione} & X.Y.Z\\ %inserire la versione più recente prensente nel changelog
                    \textbf{Approvazione} & Nome Cognome\\ %inserire nome e cognome responsabile
                    \textbf{Redazione} & Nome Cognome, Nome Cognome\\ %inserire nomi e cognomi redattori  
                    \textbf{Verifica} & Nome Cognome\\ %inserire nomi e cognomi verificatori
                    \textbf{Uso} & Uso\\ %inserire se interno o esterno
                \end{tabular}
        \end{center}
    \end{titlepage}
\restoregeometry