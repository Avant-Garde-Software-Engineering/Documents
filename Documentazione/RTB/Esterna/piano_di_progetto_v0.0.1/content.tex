...
\subsubsection{Difficoltà incontrate}\label{sec:consuntivo:analisi:difficolta}

Le principali difficoltà incontrate durante questo periodo sono state nel decidere le tecnologie utilizzate per coordinare il nostro lavoro,
 nonchè alcune difficoltà nel comunicare fra di noi in quanto, essendo un gruppo che non si conosceva precedentemente e con poca esperienza
 in questo ambito, abbiamo avuto iniziali difficoltà a coordinarci e a comunicare in modo efficace.\\
...
Abbiamo mitigato dei rischi facendo qualcosa.
