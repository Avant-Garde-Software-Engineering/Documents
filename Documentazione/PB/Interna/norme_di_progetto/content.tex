...
\begin{itemize}
    \item Interrogare il proponente sullo scopo del prodotto e le funzionalità che deve avere;
    \item Studiare il problema (anche immedesimandosi in prima persona per comprenderlo meglio) e le richieste del proponente e, a seguito, modellarne concettualmente il sistema risolutivo;
