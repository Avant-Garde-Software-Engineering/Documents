...
\begin{itemize}
    ...
    \item \textbf{Tipo:} indica la tipologia del requisito e può assumere i seguenti valori:
        ...
        \end{itemize}             
    \item \textbf{Identificativo:} si tratta di un numero progressivo univoco all'interno di uno stesso \textit{Tipo} e strutturato in forma gerarchica \textit{[idPadre].[idFiglio]}. Viene usato per contraddistinguere i requisiti e, se necessario, i loro sotto casi.
\end{itemize}
...
\begin{center}
\begin{itemize}
    \item Node.js: \url{https://nodejs.org/en} v20.11.1 \\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
    \item npm: \url{https://www.npmjs.com/} v10.7.0\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{itemize}
\end{center}
...
\begin{center}
    \url{https://react.dev/} v18.3.1\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{center}
...
\noindent Lo strumento è reperibile al sito:
\begin{center}
    \url{https://nextjs.org/} v14.2.3\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{center}
...
\noindent Lo strumento è reperibile al sito:
\begin{center}
    \url{https://threejs.org/} v0.164.1\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{center}
...
\begin{center}
\begin{itemize}
    \item R3F: \url{https://docs.pmnd.rs/react-three-fiber/getting-started/introduction} v1.0.0\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
    \item Drei: \url{https://github.com/pmndrs/drei} v2.2.21\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{itemize}
\end{center}
...
\noindent Lo strumento è reperibile al sito:
\begin{center}
    \url{https://docs.pmnd.rs/zustand/getting-started/introduction} v4.5.2\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{center}
...
\noindent Lo strumento è reperibile al sito:
\begin{center}
    \url{https://ant.design/} v0.2.0\\ \textcolor{gray}{\textit{(ultimo accesso 07-05-24)}}
\end{center}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{MPC10-CCH}: Code churn;
        \item \textbf{MPC11-NB}: Number of bugs;
        \item \textbf{MPC12-CC}: Code churn;
...
\noindent Lo strumento è reperibile al sito:
\begin{center}
    \url{https://vercel.com/} v34.1.9\\ \textcolor{gray}{\textit{(ultimo accesso 10-04-24)}}
\end{center}
...
\begin{itemize}
    \item Gli elenchi puntati devono rispettare le seguenti regole:
        ...
        \end{itemize}
    \item Le immagini sono inserite sempre con una didascalia descrittiva posizionata sotto l’immagine. Il logo è l'unica immagine che fa da eccezione a questa regola.
...
\par Le sotto attività in cui si suddivide questo processo sono infatti:
\begin{itemize}
...
\par Il processo si suddivide nelle seguenti sotto attività:
\begin{itemize}
...
\par Più nello specifico, il processo si suddivide in diverse sotto attività:
\begin{itemize}
