...
\begin{itemize}
    ...
    \url{https://github.com/Avant-Garde-Software-Engineering/WMS3D/blob/main/Documentazione/RTB/Interna/norme_di_progetto_v3.0.0.pdf} \textcolor{gray}{\textit{(ultimo accesso 04-05-24)}}
    \item Piano di Progetto v2.0.0 \\
    \url{https://github.com/Avant-Garde-Software-Engineering/WMS3D/blob/main/Documentazione/RTB/Esterna/piano_di_progetto_v1.0.0.pdf} \textcolor{gray}{\textit{(ultimo accesso 04-05-24)}}
    \item Glossario  \\
    ...
    \url{https://github.com/Avant-Garde-Software-Engineering/WMS3D/blob/main/Documentazione/RTB/Esterna/Verbali/verbale_esterno_160224_v1.0.0.pdf}\textcolor{gray} {\textit{(ultimo accesso 04-05-24)}}
